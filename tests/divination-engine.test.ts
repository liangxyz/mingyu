...
test('梅花数字起卦会在本地校验正整数输入', () => {
  ...
  assert.match(source, /readPositiveIntegerText\(draft\.meihuaNumber, '数字起卦'\)/);
});
