...
项目目前覆盖八字排盘、紫微斗数、六爻、梅花易数、奇门遁甲、大六壬、塔罗牌、三山国王灵签等场景，并尽量将结果拆分为机器可读的数据、用户可理解的摘要和适合大模型继续分析的提示词。
...
算命、AI 算命、在线算命、免费算命、智能算命、八字算命、八字排盘、紫微斗数、紫微排盘、六爻起卦、梅花易数、奇门遁甲、大六壬、塔罗占卜、塔罗抽牌、抽签、灵签、三山国王灵签、命理工具、占卜工具、运势分析、婚姻算命、事业运势、财运分析。
